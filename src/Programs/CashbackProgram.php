...
use Mbsoft\LoyaltyScore\Programs\Cashback\CashbackProgramRules;

class CashbackProgram extends LoyaltyProgram implements EarningPointsInterface, RedeemingPointsInterface
{
    protected CashbackProgramRules $rules;

    public function __construct(array $program)
    {
        parent::__construct($program);
        $this->rules = CashbackProgramRules::fromArray($program['rules']);
    }
    ...
    public function process(array $context): bool
    {
        ...
        unset($context['amount']);
        echo "\tAmount spent: " . $amount . "\n";
