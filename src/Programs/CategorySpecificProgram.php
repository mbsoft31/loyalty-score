...
use Mbsoft\LoyaltyScore\Programs\CategorySpecific\CategorySpecificProgramRules;

class CategorySpecificProgram extends LoyaltyProgram implements EarningPointsInterface, RedeemingPointsInterface
{
    protected CategorySpecificProgramRules $rules;

    public function __construct(array $program)
    {
        parent::__construct($program);
        $this->rules = CategorySpecificProgramRules::fromArray($program['rules']);
    }
